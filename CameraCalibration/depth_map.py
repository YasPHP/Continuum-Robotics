...
img_path = glob.glob('./TDCR_imgs/*')

#Load pictures and convert to grayscale
img1 = cv.imread(img_path[4], cv.IMREAD_GRAYSCALE)    # 1st pic
img2 = cv.imread(img_path[5], cv.IMREAD_GRAYSCALE)    # 2nd pic
...
points_3D = cv.reprojectImageTo3D(disparity_SGBM, Q2)
...
print ("\n Generated the point cloud file. \n")
