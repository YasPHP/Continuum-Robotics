...
# cameras 2 & 3 setup paths
img_path_cam1 = glob.glob('./calibimgs_cam2_NEW2/*')
...
print("======== PHASE 1.1: CAMERA 2 CALIBRATION ========")
...
# read images
calibration_paths_cam1 = glob.glob('./calibimgs_cam2_NEW2/*')
...
np.save("./camera_calib_params_cam2/ret", ret_cam1)
np.save("./camera_calib_params_cam2/K", K_cam1)
np.save("./camera_calib_params_cam2/dist", dist_cam1)
np.save("./camera_calib_params_cam2/rvecs", rvecs_cam1)
np.save("./camera_calib_params_cam2/tvecs", tvecs_cam1)
...
img_cam1 = cv.imread('/Users/yasmeen/Desktop/side_project_cabin/ContinuumRoboticsLab/calibimgs_cam2_NEW2/cam2_1.png')
...
cv.imwrite('calibratedImg1_cam2.png', dst)
...
cv.imwrite('calibratedImg1_cam3.png', dst_cam3)
...
img1 = cv.imread('aruco2_2_2.png', cv.IMREAD_GRAYSCALE)  # 7th pic
img2 = cv.imread('aruco3_3_3.png', cv.IMREAD_GRAYSCALE)  # 7th pic
...
# orig_img_cam1 = cv.imread(img_path_cam1[-5])
# orig_img_cam3 = cv.imread(img_path_cam1[-5])
...
# TEMPORARY COMMENTING OUT TEST 3 IMAGE B/C BAD PHOTO
