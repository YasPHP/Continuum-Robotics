...
# cameras 1 & 2 setup paths
img_path_cam1 = glob.glob('./calibimgs_cam1_NEW2/*')
img_path_cam3 = glob.glob('./calibimgs_cam2_NEW2/*')
#---------------------------------------------------------- Camera Calibration ----------------------------------------------------------#
...
print("======== PHASE 1.3: CAMERA 2 CALIBRATION ========")
...
calibration_paths_cam3 = glob.glob('./calibimgs_cam2_NEW2/*')
...
img_cam3 = cv.imread('/Users/yasmeen/Desktop/side_project_cabin/ContinuumRoboticsLab/calibimgs_cam2_NEW2/cam2_1.png')
cv.imshow('cam2_1.png', img_cam3)
...
img2 = cv.imread('aruco2_2_2.png', cv.IMREAD_GRAYSCALE)
...
projPoints1 = np.array(detectAruco(img_test_1, markerSize=6, totalMarkers=250, draw=True))  # clockwise points detected
